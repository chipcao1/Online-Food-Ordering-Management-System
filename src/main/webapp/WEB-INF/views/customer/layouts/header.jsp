                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="user_option">
                        <a class="cart_link" href="${pageContext.request.contextPath}/cart">
                            ...
                            <span class="badge badge-warning" style="font-size: 0.6rem; vertical-align: top; margin-left: -5px;">
                                ${sessionScope.cart != null ? sessionScope.cart.items.size() : 0}
                            </span>
                        </a>
                        <c:choose>
                            <c:when test="${not empty sessionScope.loggedInUser}">
                                <a href="${pageContext.request.contextPath}/logout" class="order_online ms-3" style="background-color: #dc3545; color: white;">Logout</a>
                            </c:when>
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/login" class="order_online ms-3">Login</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
